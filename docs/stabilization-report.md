...
| STAB-008 | P2 | Git executable is unavailable in the current execution environment | Branch cleanliness, origin sync, and diff checks cannot be verified here | Run the Git workflow from a normal Git-enabled developer shell before PR creation |

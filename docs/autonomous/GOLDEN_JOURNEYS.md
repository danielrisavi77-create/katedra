...
| G7 | Lekta check, sanitized handoff, remediation and fresh re-check | BLOCKED_EXTERNAL | Browser E2E exists; material deletion now has a local tombstone contract but its canonical deployment/proof and complete Lekta preview/DOCX fixture execution still require staging |

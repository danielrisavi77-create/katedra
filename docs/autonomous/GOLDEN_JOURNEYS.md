...
| G9 | Network, session, provider, balance, checkout and malformed-state failures recover honestly | BLOCKED_EXTERNAL | Route/unit failure tests pass; authenticated provider, session and payment failure recovery requires staging |

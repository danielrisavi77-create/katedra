...
export const REQUIRED_AGENTIC_FUNCTIONS = [
  ...
  'claim_agent_step',
  'complete_agent_step',
  'claim_agent_provider_execution',
  'start_agent_provider_execution',
  'record_agent_provider_response',
  'commit_agent_provider_response',
  'settle_agent_provider_execution',

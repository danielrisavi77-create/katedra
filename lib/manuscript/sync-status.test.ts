...
describe('syncMetadata', () => {
  ...
  it('accepts a canonical project response when the submitted id is its legacy guest alias', async () => {
    const result = await syncMetadata({ ...input, projectId: 'klegacy' }, true, async () => new Response(JSON.stringify({

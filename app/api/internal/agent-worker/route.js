...
const MODEL = process.env.KATEDRA_AGENT_MODEL || 'claude-sonnet-5'
...
export async function POST(req) {
  ...
  const provider = createAnthropicAgentProvider({ apiKey: process.env.ANTHROPIC_API_KEY, model: MODEL })

...
# Finish nikad ne objavljuje izravno s mastera.
if ($branch -eq 'master') {
...
# GitHub Action automatski otvara draft PR za claude/* brancheve.
# Compare stranica se otvara kao fallback ako je repo konfiguracija blokira.
$repoSlug = $null
